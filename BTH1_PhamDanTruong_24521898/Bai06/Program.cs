    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    Delete_Column_MaxSum_Func(ref Matrix,ref n, ref m);
                } else
                {
        ...
        static void Delete_Column_MaxSum_Func(ref int[,] Matrix,ref  int n, ref int m)
        {
            DeleteMaxValue(ref Matrix,ref n, ref m);
        ...
        static void Row_With_Largest_Sum_Func(int[,] Matrix, int n, int m)
        {
            ...
            if (index ==0 )
            {
                Console.WriteLine("Khong ton tai dong.");
                return;
            }
            index++;
        ...
        static void DeleteMaxValue(ref int[,] Matrix, ref int n, ref int m)
        {
